      ...
      <div class="main-box">
        <div :class="['container', 'container-register', { 'is-txl': isLogin }]">
          <form>
            ...
            <input class="form__input" type="text" placeholder="请输入用户名" v-model = "registerForm.userAccount"/>
            <input class="form__input" type="password" placeholder="请输入密码" v-model = "registerForm.userPassword"/>
            <input class="form__input" type="password" placeholder="请输入密码" v-model = "registerForm.checkPassword"/>
        ...
        <div :class="['container', 'container-login', { 'is-txl is-z200': isLogin }]">
          <form>
            ...
            <input class="form__input" type="text" placeholder="用户名/邮箱/手机号" v-model="loginForm.userAccount" />
            <input class="form__input" type="password" placeholder="请输入密码" v-model="loginForm.userPassword" />
  ...
  <script setup lang="ts">
    ...
    const login = async () => {
      ...
      if (res.code === 0) {
        ...
        userStore.userAccount = loginForm.userAccount || "not login"
